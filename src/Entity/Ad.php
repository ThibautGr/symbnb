...
class Ad
{
    ...
    /**
     * Retourne un tableau des jours occuper
     * @return array
     */
    public function getNotAvalibleDate(): array
    {
        $notAvailableDAys= [];
    ...
    /**
     * Permet de récuperle commentaire de l'ulisateur
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Permet d'obtnir la moyenne globale des notes de l'annonce
     *
     * @return float|int
     */
    public function getAvgRattings(){
